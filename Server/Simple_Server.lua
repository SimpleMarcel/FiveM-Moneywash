...
AddEventHandler("Simple_Moneywash:CustomOffer", function(amount)
    ...
    local SimpleWaschKosten = math.ceil(amount * SimpleWaschKostenProzent)
    local totalCost = amount + SimpleWaschKosten
    if SimpleSchwarzgeld >= totalCost then
        if SimpleSchwarzgeld >= SimpleWaschKosten then
            xPlayer.addMoney(amount)
            xPlayer.removeAccountMoney('black_money', SimpleWaschKosten)
