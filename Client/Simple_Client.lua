...
local notifyShown = false -- Variable zur Verfolgung des Benachrichtigungsstatus
...
Citizen.CreateThread(function()
    while true do
        ...
        if distance <= 3 then
            if not notifyShown then -- Nur wenn die Benachrichtigung noch nicht gezeigt wurde
                ...
                notifyShown = true -- Setze den Status auf true, um anzuzeigen, dass die Benachrichtigung gezeigt wurde
            end
